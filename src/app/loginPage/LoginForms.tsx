    ...
    <div className="w-96 md:w-5/12 h-auto mx-auto bg-gray-300 rounded-3xl shadow-xl ">
      {login ? (
        <div className="relative mt-10 md:w-11/12 mx-auto h-auto  ">
          <h2 className=" mt-8 inline-block text-black text-2xl border-b-2 border-black font-bold">ログイン</h2>
          <button
          ...
          <ul className="flex-col items-center mx-auto py-10 w-8/12">
            ...
            <li className="bg-green-600 text-xl rounded-full py-3  text-white border-4 border-green-600 mb-3 hover:boder-2  hover:border-gray-50 cursor-pointer shadow-lg">
              GitHubでログイン
            </li>
            <li
          ...
          <button className="bg-green-500 w-5/12 h-10 rounded-md mb-12 border-2 border-gray-50 shadow-md" onClick={() => setLogin(!login)}>
            新規登録はこちら
          </button>
        </div>
      ) : (
        <div className="relative mt-10 md:w-11/12 mx-auto h-auto  ">
        <h2 className=" mt-8 inline-block text-black text-2xl border-b-2 border-black font-bold">新規登録</h2>
        <button
          className="absolute top-2 left-3 text-blue-400 hover:opacity-70"
          onClick={() => router.back()}
        >
